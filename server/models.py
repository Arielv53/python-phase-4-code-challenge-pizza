...
class Restaurant(db.Model, SerializerMixin):
    ...
    # add relationship
    rest_pizzas = db.relationship('RestaurantPizza', back_populates='restaurant', cascade='all, delete-orphan')
...
class Pizza(db.Model, SerializerMixin):
    ...
    # add relationship
    rest_pizzas = db.relationship('RestaurantPizza', back_populates='pizza', cascade='all, delete-orphan')
...
class RestaurantPizza(db.Model, SerializerMixin):
    ...
    restaurant = db.relationship('Restaurant', back_populates='rest_pizzas')
